...
in
{
  ...
  xdg.configFile."bash" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/bash";
    recursive = true;
  };

  xdg.configFile."nvim" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/nvim";
    recursive = true;
  };

  xdg.configFile."sway/config" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/sway/config";
  };
  xdg.configFile."sway/config.d" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/sway/config.d";
    recursive = true;
  };
  xdg.configFile."sway/scripts" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/sway/scripts";
    recursive = true;
  };

  xdg.configFile."quickshell" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/quickshell";
    recursive = true;
  };
  xdg.configFile."rmpc/config.ron".source =
    config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.ndots/config/rmpc/config.ron";
